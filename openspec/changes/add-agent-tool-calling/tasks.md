...
- [ ] 1.3 为 MCP YAML 配置解析新增单元测试，覆盖默认缺省、环境变量覆盖、TOML 覆盖、无文件不报错、stdio 配置、Streamable HTTP 配置和格式错误。
...
- [ ] 5.1 更新 README，说明 MCP YAML 默认路径、覆盖方式、stdio 示例、Streamable HTTP 示例，并明确 V1 不提供通用 HTTP Tool。
